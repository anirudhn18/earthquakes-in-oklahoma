...
disposal_wells = pd.read_csv('../Files/processed-data/well_header.csv', index_col=33, parse_dates=True)
...
cum_disposal_wells_past20 = cum_disposal_wells_per_year.ix[2000:2015]
...
plt.savefig('../Plots/disposal-wells-vs-eq.png')